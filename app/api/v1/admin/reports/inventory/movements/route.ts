...
// ============================================================================
// PROXY: app/api/v1/admin/reports/inventory/movements/route.ts -> Django backend
// ============================================================================
...
const DJANGO_REPORT_ENDPOINT = `${DJANGO_API_BASE_URL}/api/v1/admin/reports/inventory/movements/`;

export async function GET(request: NextRequest) {
  const { searchParams } = new URL(request.url);

  const djangoParams = new URLSearchParams();
  for (const key of ['search', 'movement_type', 'date_from', 'date_to', 'sort', 'report_format']) {
